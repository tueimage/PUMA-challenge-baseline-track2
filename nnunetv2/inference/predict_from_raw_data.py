...
if __name__ == '__main__':
    ...
    nnUNet_raw="/opt/app/nnunetv2/nnunetv2_hist/nnUNet_raw"
    nnUNet_results="/opt/app/nnunetv2/nnunetv2_hist/nnUNet_results"
    ...
    predictor.predict_from_files(join(nnUNet_raw, 'Dataset526_Mark/imagesTs'),
                                 join(nnUNet_raw, 'Dataset526_Mark/imagesTs_pred'),
