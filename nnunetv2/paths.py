...
nnUNet_raw = '/workspaces/nnUNet/nnunetv2/nnunetv2_hist/nnUNet_preprocessed'
nnUNet_preprocessed = '/workspaces/nnUNet/nnunetv2/nnunetv2_hist/nnUNet_raw'
nnUNet_results = '/workspaces/nnUNet/nnunetv2/nnunetv2_hist/nnUNet_results'
